...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="Assets/Images/Rectangle 179.png">
    <title></title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.html">
                        <!-- Logo icon -->
                        <b><img src="Assets/Images/logoicon.png" alt="homepage" class="dark-logo" /></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <!-- <span><img src="images/logo-text.png" alt="homepage" class="dark-logo" /></span> -->
                        <span>इटेकनेब्यूला</span>
                    </a>
                </div>
                <!-- End Logo -->
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- Profile -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="Assets/Images/Ellipse 635.png" alt="user" class="profile-pic" /></a>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Dashboard <span class="label label-rouded label-primary pull-right">2</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                                <!-- <li><a href="dashboard.html">Ecommerce </a></li>
                                <li><a href="index1.html">Analytics </a></li> -->
                                <li><a href="Request_a_Quote_now.php"> Request a quote </a></li>
                                <li><a href="index1.html">Industries </a></li>   
                                <li><a href="Offers.php">Offers </a></li>   
                                <li><a href="index1.html">Visitor</a></li>
                            </ul>
                        </li>
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-suitcase"></i><span
                                    class="hide-menu">Bootstrap UI <span
                        ...
                        <!-- <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-suitcase"></i><span
                                    class="hide-menu">Components <span
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-table"></i><span
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-map-marker"></i><span
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body browser">
                                ...
                                <!-- <p class="f-w-600">Desktop <span class="pull-right"> -->
                                <?php echo '<p class="f-w-600">Desktop <span class="pull-right">' . $row['pc_count']  . '</span></p>'; ?>
                                </span></p>
                                <!-- <div class="progress ">
                                ...
                                <?php echo '<p class="f-w-600">Mobile <span class="pull-right">' . $row['mobile_count'] . '</span></p>'; ?>
                                <!-- <div class="progress">
                                ...
                                <?php echo '<p class="f-w-600">Tablet <span class="pull-right">' . $row['tablet_count'] . '</span></p>'; ?>
                                <!-- <p class="m-t-30 f-w-600">Tablet<span class="pull-right">0</span></p>
                                <div class="progress">
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-title">
                                        <h4 class=""> <span class="badge badge-danger">Subscribe Email </span></h4>
                                    </div>
                                    <div class="recent-comment">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                $selectquery1 = "select * from email";
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><span class=""><?php echo $res1['id']; ?></span></td>
                                                                <td><span class=""><?php echo $res1['email']; ?></span></td>
                                                            </tr>
                                                        <?php
                                                        }
                                                        ?>
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2023 All rights reserved. designed by <a href="https://itechnebula.com">itechnebula</a></footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
