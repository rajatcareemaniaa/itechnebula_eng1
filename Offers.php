    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-primary">Offers Details</h3>
        ...
        <div class="row d-flex justify-containt center align-items-center">
            <div class="c0l-md-8">
                <div class="card">
                    <div class="card-title">
                        <h4> <span class="badge badge-success">OFFERS DETAILS</span> </h4>
                    </div>
                    <div class="card-body">
