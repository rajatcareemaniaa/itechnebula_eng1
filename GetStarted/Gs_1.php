        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              ...
              <h1 class="ck_gs_text1  mx-auto">Request Your Free 30-Minute Scaling Growth Map for IT Consultation</h1>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row position-relative">
        ...
        <div class="d-flex justify-content-between flex-wrap">
          ...
          <div class="d-flex">
            <a href=""><img src="https://ik.imagekit.io/cowe9tcww/Assets/Images/Facebook.png?updatedAt=1706168302232" class="img-fluid h-25 mss_iconFacebook" alt="icon"> </a>
            <a href=""> <img src="https://ik.imagekit.io/cowe9tcww/Assets/Images/LinkedIn.png?updatedAt=1706168310883" class="img-fluid mx-3 h-25 mss_iconFacebook" alt="icon"></a>
            <a href=""> <img src="https://ik.imagekit.io/cowe9tcww/Assets/Images/Instagram.png?updatedAt=1706168309599" class="img-fluid h-25 mss_iconFacebook" alt="icon"></a>
          </div>
        </div>
